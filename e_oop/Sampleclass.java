...
public class Sampleclass {
	...
	public static void main(String[] args) {
		int local = 10;//지역변수 : 메서드 안에서만 사용한 변수
	}
	
	
	int field; //전역변수 : 클래스 전체 영역에서 사용하는 변수 // 초기화하지 않아도 자동으로 기본값으로 초기화가 된다.
	/*
	 *  char : ' '(0)
	 *  boolean : false
	 * 	참조형타입 : null
	 ...
	 *  - 리턴타입(반환타입) : 실행 후 돌려줘야하는 결과물, 메서드를 종류시키는 역할
	 */
	...
	void flowTest1(){
		...
		flowTest3();
		System.out.println("flowTest2종료 : 6");
	}
	
	void flowTest2(){
		System.out.println("flowTest1시작 : 3");
